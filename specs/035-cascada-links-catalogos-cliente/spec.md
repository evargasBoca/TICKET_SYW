...
- **FR-005**: El formulario de Ticket y el formulario de Tarea MUST incluir un campo de selección de Skills requeridas sobre el catálogo de skills existente, respetando el permiso `tickets:manage_skills` ya vigente para determinar si el campo es editable o de solo lectura.
