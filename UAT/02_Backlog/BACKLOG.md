...
| OBS-0029 | SLA Configurable | Defecto | Lista para Validar | Arely Pazmiño | ITER-004 | — | Falta mensaje de confirmación al crear una configuración SLA |
| OBS-0030 | SLA Configurable | Defecto | Lista para Validar | Arely Pazmiño | ITER-004 | — | Tiempos mínimos de SLA se modifican automáticamente a 1 sin informar al usuario |
| OBS-0031 | SLA Configurable | Mejora | Lista para Validar | Arely Pazmiño | ITER-004 | — | Falta longitud máxima para los tiempos configurables del SLA |
| OBS-0032 | Tickets > Detalle del Ticket | Mejora | Lista para Validar | Arely Pazmiño | ITER-004 | — | Mejorar visualización del estado inicial del SLA (fase Contacto desde la creación) |
| OBS-0033 | Tickets > Nuevo Ticket | Defecto | Lista para Validar | Arely Pazmiño | ITER-004 | — | Título del ticket permite ingresar solo espacios en blanco |
| OBS-0034 | Tickets > Nuevo Ticket | Mejora | Lista para Validar | Arely Pazmiño | ITER-004 | — | Revisar validación de caracteres especiales/emojis en el título del ticket |
| OBS-0035 | Tickets > Detalle del Ticket > Registro de tiempos | Defecto | Lista para Validar | Arely Pazmiño | ITER-004 | — | Registro de tiempo continúa disponible/activo después de cerrar el ticket |
