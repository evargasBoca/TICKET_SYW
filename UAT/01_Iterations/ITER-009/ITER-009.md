...
**Nota de renumeración (colisión de IDs entre ramas)**: esta iteración se preparó originalmente como `ITER-008` (`OBS-0044`–`OBS-0047`) en una rama de trabajo aislada. Antes de integrarse, `main` ya había incorporado, en paralelo, un `ITER-008` distinto (barrido E2E de Emilio Vargas, `OBS-0044`–`OBS-0059`, PR #38). Para no reutilizar IDs ya asignados a observaciones distintas (`CONVENTIONS.md` — los IDs "nunca se reutilizan ni se renumeran" una vez publicados), esta iteración se registra como `ITER-009` y sus observaciones como `OBS-0060`–`OBS-0063` al integrarse a `main`/`develp_Jp`. El contenido narrativo (descripciones, criterios de aceptación, evidencia) es idéntico al preparado originalmente; solo cambian los IDs `ITER-XXX`/`OBS-XXXX`.
...
**Nota de evidencia**: el documento fuente adjunta 4 imágenes sin asociación explícita 1 a 1 con cada hallazgo. Se asignaron por contenido: las dos capturas del formulario "Nuevo registro de tiempo" (hora ingresada `17:37–17:38`) y del historial resultante (`22:37–22:38`, un desfase de ~5 horas) se asociaron a `OBS-0060` (par entrada/resultado); la captura del historial con la etiqueta "Fuera de jornada" superpuesta a los horarios `22:16–22:17` / `23:16–23:17` / `05:00–05:01` se asoció a `OBS-0061`; la captura del detalle de ticket con la notificación de asignación visible se asoció a `OBS-0062`. `EA-027` no tenía evidencia gráfica adjunta en el documento fuente.

**Nota de pasos para reproducir**: el documento fuente no incluye una sección explícita "Pasos para reproducir" (a diferencia de `ITER-004`/`005`). Para los hallazgos de tipo `Defecto` (`OBS-0060`, `OBS-0063`), donde `CONVENTIONS.md` la exige, se derivaron a partir de la narrativa ya descrita en "Descripción"/"Resultado actual", sin agregar información no presente en el documento original.

## Resumen de observaciones

| ID | Módulo/Pantalla | Tipo | Estado | Reportado por |
|---|---|---|---|---|
| OBS-0060 | Registro de tiempos > Historial de registros | Defecto | Abierta | Arely Pazmiño |
| OBS-0061 | Registro de tiempos > Historial de registros | Mejora | Abierta | Arely Pazmiño |
| OBS-0062 | Panel de Asignación / Notificaciones | Mejora | Abierta | Arely Pazmiño |
| OBS-0063 | Panel de Asignación | Defecto | Abierta | Arely Pazmiño |

## Detalle de observaciones

### OBS-0060 — El historial de registros de tiempo muestra una hora diferente a la hora real del registro

- **Módulo/Pantalla:** Registro de tiempos > Historial de registros
- **Tipo:** Defecto
- **Estado:** Abierta
- **Reportado por:** Arely Pazmiño
- **Iteración de origen:** ITER-009
- **Iteración de cierre:** —
...
**Evidencia**
![Formulario "Nuevo registro de tiempo" del ticket TK-000003 ingresando hora de inicio/fin 17:37–17:38](images/OBS-0060-01.png)
![Historial de registros de tiempo del ticket TK-000003 mostrando el registro como 22:37–22:38, un desfase de ~5 horas respecto a la hora ingresada](images/OBS-0060-02.png)

### OBS-0061 — La etiqueta "Fuera de jornada" dificulta la visualización del horario registrado
...
**Evidencia**
![Historial de registros de tiempo del ticket TK-000003 con la etiqueta "Fuera de jornada" superpuesta a los horarios 22:16–22:17, 23:16–23:17 y 05:00–05:01](images/OBS-0061-01.png)

### OBS-0062 — No se genera una notificación al cambiar el resolutor de un ticket
...
**Evidencia**
![Detalle del ticket TK-000003 con una notificación de asignación visible en el centro de notificaciones](images/OBS-0062-01.png)

### OBS-0063 — El sistema permite asignar tickets a usuarios inactivos
